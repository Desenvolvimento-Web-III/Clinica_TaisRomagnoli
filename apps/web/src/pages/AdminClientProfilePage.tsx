...
export function AdminClientProfilePage({
  ...
  return (
    <div className="relative min-h-dvh bg-[var(--color-canvas-neutral)] text-[var(--color-text-primary)]">
      <BrandLogo />
      <header className="bg-[var(--color-brand-strong)] text-white">
        <div className="mx-auto max-w-6xl px-4 pb-6 pt-32 sm:px-6 lg:px-8">
          ...
          <div className="mt-3 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <p className="text-sm/5 text-white/85">Perfil administrativo do cliente</p>
              <h1 className="mt-1 text-2xl/8 font-bold">{profile.fullName}</h1>
            </div>
            <span className="w-fit rounded-full border border-white/40 bg-white/15 px-3 py-1 text-sm font-semibold">
              ...
              {profile.anamnesis ? (
                <div className="space-y-5 text-sm/5">
                  <div className="rounded-xl border border-[var(--color-warning-border)] bg-[var(--color-warning-bg)] p-3 text-[var(--color-warning-text)]">
                    Acesso restrito. Consulte estes dados apenas quando necessário para o
                    atendimento.
                  </div>
                  <div>
