...
describe('ambiente de teste', () => {
  it('permite iniciar o smoke test sem conexão Firebase', async () => {
    ...
    vi.stubEnv('VITE_FIREBASE_API_KEY', undefined as any);
    vi.stubEnv('VITE_FIREBASE_AUTH_DOMAIN', undefined as any);
    vi.stubEnv('VITE_FIREBASE_PROJECT_ID', undefined as any);
    vi.stubEnv('VITE_FIREBASE_STORAGE_BUCKET', undefined as any);
    vi.stubEnv('VITE_FIREBASE_MESSAGING_SENDER_ID', undefined as any);
    vi.stubEnv('VITE_FIREBASE_APP_ID', undefined as any);
